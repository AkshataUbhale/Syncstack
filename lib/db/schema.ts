/**
 * Database Schema for Syncstack
 *
 * This file defines the database structure for our Syncstack application.
 ...
 * Files Table
 *
 * This table stores all files and folders in our Syncstack.
